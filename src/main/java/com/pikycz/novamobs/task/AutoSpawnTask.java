    ...
    public void run() {
        ...
        Server.getInstance().getOnlinePlayers().forEach((name, player) -> {
            if (Server.getInstance().getOnlinePlayers().size() > 0) {
                ...
                if (spawnMonsters) {
                    if (time >= Level.TIME_NIGHT && time < Level.TIME_SUNRISE && biomeId != 8) {
                ...
                if (spawnAnimals) {
                    if (time >= Level.TIME_SUNRISE || time < Level.TIME_SUNSET && biomeId != 8) {
                        if (biomeId == 14) {
                        ...
                        if (biomeId == 4 || biomeId == 27 || biomeId == 5) {
